...
<script src="<?php echo base_url('assets') ?>/js/html5sql.js"></script>
...
<script src="<?php echo base_url('assets') ?>/js/plugin/inputmask/jquery.inputmask.bundle.min.js"></script>
<script src="<?php echo base_url('assets') ?>/js/plugin/inputmask/inputmask.date.extensions.min.js"></script>
