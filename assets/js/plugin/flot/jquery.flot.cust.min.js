		...
		function R() {
			if (null != ea.legend.container ? a(ea.legend.container).html("") : c.find(".legend").remove(), ea.legend.show) {
				...
				for (var i = 0; i < f.length; ++i) {
					var k = f[i];
					i % ea.legend.noColumns == 0 && (g && e.push("</tr>"), e.push("<tr>"), g = !0), e.push('<td class="legendColorBox"><div style="' + ea.legend.labelBoxBorderColor + '"><div style="border:2px solid ' + k.color + ';overflow:hidden"></div></div></td><td class="legendLabel"><span>' + k.label + "</span></td>")
				}
