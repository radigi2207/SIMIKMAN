...
function load_config()
{
    ...
    //    $CI->session->userdata('status') == "INACTIVE" &&
    //    $CI->uri->segment(1) != "router" &&
    //    $CI->uri->segment(1) != "check_mikrotik" &&
    ...
    if(!$CI->session->userdata('login') &&
       ...
       $CI->uri->segment(1) != 'login' &&
       $CI->uri->segment(1) != 'register' &&
       $CI->uri->segment(1) != 'reg' &&
       $CI->uri->segment(1) != 'daftar' &&
       $CI->uri->segment(2) != 'hotspot_notif' &&
       $CI->uri->segment(1) != 'hotspot'
    ...
    //     load_language_files('system/language', current_language());
