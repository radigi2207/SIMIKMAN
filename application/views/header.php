...
>
	<head>
		...
		<link rel="stylesheet" type="text/css" media="screen" href="<?=base_url('assets/css/ladda.min.css')?>">
	...
	<body class="fixed-header fixed-navigation fixed-ribbon fixed-page-footer">
		...
		?>
				<!-- HEADER -->
				<header id="header">
					<div id="logo-group hidden">

						<!-- PLACE YOUR LOGO HERE -->
						<h3 class='' style="margin:13px 0 13px 13px;"><?=$this->config->item("site_title")?></h3>
					...
					<div class="pull-right">
						...
						<div id="logout" class="btn-header transparent pull-right">
							<span> <a href="<?=site_url('logout')?>" data-title="<?=$this->lang->line('login_logout')?>" data-action="userLogout" data-logout-msg="<?=$this->lang->line('login_logout_desc')?>"><i class="fa fa-sign-out"></i></a> </span>
						</div>
						<!-- end logout button -->

						<!-- search mobile button (this is hidden till mobile view port) -->
						<div id="search-mobile" class="btn-header transparent pull-right">
							<span> <a href="javascript:void(0)" title="Router"><i class="zmdi zmdi-router"></i></a> </span>
						</div>
						...
						<!-- fullscreen button -->
						<div id="fullscreen" class="btn-header transparent pull-right hidden-sm hidden-xs">
						...
						<div class="btn-header transparent pull-right hidden-sm hidden-xs"> 
							<span ><a id="refresh" data-action="refreshContent" data-action="refreshContent" title="Refresh"><i class="fa fa-refresh fa-spin"></i></a></span> 
						</div>
						...
						<ul class="header-dropdown-list hidden-xs hidden">
							<li>
								<a href="#" class="dropdown-toggle" data-toggle="dropdown"> 
									<img src="<?php echo base_url('assets') ?>/img/blank.gif" class="flag flag-us" alt="United States"> <span> US</span> <i class="fa fa-angle-down"></i> </a>
								<ul class="dropdown-menu pull-right">
									<li >
									...
									<li class="active" data-value="id:indonesian">
										<a href="javascript:void(0);"><img src="<?php echo base_url('assets') ?>/img/blank.gif" class="flag flag-id" alt="France"> Indonesia</a>
									</li>						
								</ul>
							</li>
						</ul>
