				...
				<div>
					...
					<div class="widget-body no-padding">
                        <div class="row smart-form padding-top-10 padding-bottom-10">
                            ...
                            <div class="col col-lg-6 col-xs-12 col-sm-4 col-md-4 padding-top-10 ">
...
function get_data()
{
	...
	if(startdate.length != 0 && finishdate.length != 0)
	{
		...
		$.ajax({
			url :"<?=site_url('report/get_periode')?>",
...
function excel()
{
    ...
    if(startdate.length != 0 && finishdate.length != 0)
	{
		window.open("<?=site_url()?>export/periode/"+startdate+"/"+finishdate);
	}
}
</script>